...
SELECT db.[name] AS [DatabaseName]
    ...
    ,'CREATE INDEX [idx_' + OBJECT_NAME(id.[object_id], db.[database_id]) + '_' + REPLACE(REPLACE(REPLACE(ISNULL(id.[equality_columns], ''), ', ', '_'), '[', ''), ']', '') + CASE
...
WHERE  db.[database_id] = DB_ID()
	AND object_schema_name(id.[object_id], db.[database_id]) NOT IN  ('dbo', '<schema names>')
